...
/*
    ...
    @file      : FloatingVideoPlayer.js
    @version   : 1.0.0
    @author    : Paul Cornwell, Jeremy Oliver, Jonathan Vazquez, Moiz Ali
    @date      : 8/3/2018
    @copyright : Veriforce 2018
    @license   : Apache 2
...
define([
    ...
    "FloatingVideoPlayer/lib/jquery-1.11.2",
    "dojo/text!FloatingVideoPlayer/widget/template/FloatingVideoPlayer.html"
    ...
    return declare("FloatingVideoPlayer.widget.FloatingVideoPlayer", [ _WidgetBase, _TemplatedMixin ], {
...
require(["FloatingVideoPlayer/widget/FloatingVideoPlayer"]);
